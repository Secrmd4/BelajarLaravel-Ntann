            ...
            <div class="card-body">
                <form method="post" action="/saveblog" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="isi_post" id="isi-post" cols="30" rows="5" name="isi_post" placeholder="isi post">
                        </textarea>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="text-end">
                        <button type="post" class="btn btn-secondary">post</button>
                    </div>
                    </div>
                </form>
            </div>  
